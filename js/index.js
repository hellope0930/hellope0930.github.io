...
$(function () {
   ...
   /////////////倒计时
    ...
    //////////////购物车
   $("#body #cont .cont_left ul li div .shop").click(function(){
...
$("#shopBar p").hover(function(){
    ...
    $(this).parent().find(".move").css({display:"block",left:$(this).offset().left,top:$(this).offset().top-y}).html(tooltip).stop().animate({left:$(this).offset().left-100,top:$(this).offset().top-y})
},function(){
